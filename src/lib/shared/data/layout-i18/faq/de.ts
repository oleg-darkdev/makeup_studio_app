	...
	faq: [
		{
			...
			a: [
				'Für Anfänger, die die "Eyeliner"-Technik erlernen möchten.',
				'Für erfahrene PMU-Artists, die ihr Wissen vertiefen und ihre Ergebnisse verbessern möchten.',
				'Für diejenigen, die sich auf Wettbewerbe vorbereiten und ein höheres professionelles Niveau erreichen wollen.'
			]
		},
		{
		...
		{
			q: 'Erhalte ich nach Abschluss des Kurses ein Zertifikat?',
			a: [
				'Ja — nach Abschluss des Kurses erhalten Sie ein Zertifikat, das Ihre praktischen Kenntnisse bestätigt.'
			]
		},
		{
