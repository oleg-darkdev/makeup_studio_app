	...
	targetAudience: [
		{
			...
			decoration: '',
			desc: [
				`Du beginnst gerade deine Reise in die Welt des Make-ups? Der EYE LINER-Kurs hilft dir, die Grundlagen zu verstehen und zeigt dir Schritt für Schritt, wie du den perfekten Lidstrich ziehst – von einfachen Techniken bis hin zu kreativeren Formen. Mit den klaren Anleitungen von Valeria Vasilyeva gewinnst du Sicherheit in deiner Handführung und entdeckst, dass Eyeliner dein bester Verbündeter im täglichen Make-up sein kann.`
			]
		},
		{
