const ru = {
	title: 'Прокачаешь навыки в течении',
	course: 'курса',
	...
	data: [
		...
		},
		{
			...
			title: 'Техники растушёвки'
		},
		{
			avif: '/images/results/cropped/result_4.avif',
			image: '/images/results/cropped/result_4.png',
			title: 'Участие в чемпионатах'
		},
		{
			avif: '/images/results/cropped/result_5.avif',
			image: '/images/results/cropped/result_5.png',
			title: 'Понимание градиентов'
		},
		{
		...
		// { image: '', title: 'Сертификат у мастера мира' }
	]
};
