const targetAudiencePl = [
	{
		...
		decoration: '',
		desc: [
			`Dopiero zaczynasz swoją przygodę z makijażem? Kurs EYE LINER pomoże Ci zrozumieć podstawy i nauczy Cię krok po kroku, jak stworzyć idealną kreskę – od prostych technik po bardziej kreatywne formy. Dzięki jasnym instrukcjom Valerii Vasilyevej zyskasz pewność ręki i odkryjesz, że eyeliner może być Twoim najlepszym sprzymierzeńcem w codziennym makijażu.`
		]
	},
	{
		title: 'Praktykujące',
